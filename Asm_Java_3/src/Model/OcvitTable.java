...
public class OcvitTable {
    ...
    public OcvitTable(Integer Id, Integer CategoryId, String ProductName, BigDecimal CurrenPrice, Integer Quantity, String Origin, String Uses) {
        this.Id = Id;
